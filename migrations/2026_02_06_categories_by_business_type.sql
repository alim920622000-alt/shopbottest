...
-- Запуск: sqlite3 shop.db < migrations/2026_02_06_categories_by_business_type.sql
-- Проверка категорий: sqlite3 shop.db "SELECT business_type, COUNT(*) FROM categories GROUP BY business_type;"
-- Проверка products: sqlite3 shop.db "SELECT id, shop_id, category_id FROM products LIMIT 5;"
