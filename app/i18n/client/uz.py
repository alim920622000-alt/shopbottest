...
TEXTS: dict[str, str] = {
    ...
    "pickup": "🚶 Олиб кетиш",
    "dine_in": "🍽 Залда",
    "order.repeat": "🔁 Буюртмани такрорлаш",
    "order.repeat.added": "✅ Саватга қўшилди: {count}",
    "order.repeat.skipped": "⚠️ Мавжуд эмас: {names}",
    "order.repeat.unavailable": "Буюртмани такрорлаш фақат якунланган ёки бекор қилинган буюртмалар учун мавжуд.",
    "common.no_access": "Рухсат йўқ.",
    "chat.closed": "Чат ёпилган.",
    "cart.title.default": "🧺 Сават",
    ...
    "order.status.new": "🆕 Янги",
    "order.status.preparing": "⏳ Тайёрланмоқда",
    "order.status.ready": "📦 Тайёр",
    "order.status.picked_up": "🛵 Курер йулда",
    ...
    "order.arrival.cancel": "↩️ Бекор қилиш",
    "order.arrival.back": "🔙 Буюртмаларга қайтиш",
    "order.arrival.done": "Буюртма тасдиқланди.",
    "nav.courier_arrived_button": "⚠  Курер етиб келди  ⚠",
